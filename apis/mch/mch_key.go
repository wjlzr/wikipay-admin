...
//列表
func GetMchKeyList(c *gin.Context) {
	var (
		data      mch.MchKey
		info      string
		err       error
...
//添加
func InsertMchKey(c *gin.Context) {
	var data mch.MchKey
...
//更新
func UpdateMchKey(c *gin.Context) {
	var data mch.MchKey
...
//删除
func DeleteMchKey(c *gin.Context) {
	var data mch.MchKey
